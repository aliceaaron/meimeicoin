...
const QString BITCOIN_IPC_PREFIX("Meimeicoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Meimeicoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Meimeicoin: click-to-pay handler");
    else
...
{
    // clicking on Meimeicoin: URLs creates FileOpen events on the Mac:
