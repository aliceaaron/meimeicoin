...
static const int64_t MAX_MONEY = 380000000 * COIN;
...
public:
    ...
    {
        // Meimeicoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Meimeicoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Meimeicoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Meimeicoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Meimeicoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Meimeicoin: block index flags
    enum  
    {
